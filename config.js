...
global.sudo = process.env.SUDO || '94719342087'
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'AROSH BOT' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Arosh Samuditha' : process.env.OWNER_NAME,
